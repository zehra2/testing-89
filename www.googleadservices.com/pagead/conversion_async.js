(function() {
    ...
    */
    ...
    function y(a, b, c) {
        if (b) a: {
            ...
            d = d[d.length - 1];c = da && "es6" === c ? f[d] : null;b = b(c);null != b && (a ? l(v, d, {
                configurable: !0,
                writable: !0,
                value: b
    ...
    */
    ...
    function Kb(a, b) {
        var c = "query";
        if ("protocol" === c || "port" === c) a.protocol = Lb(a.protocol) || Lb(H.location.protocol);
    ...
    function Yc(a, b, c, d, e, f) {
        ...
        switch (e) {
            ...
            case 1:
                ...
                break;
            case 6:
                    k = "www.google.com/";m = "ccm/conversion/";h = "";
                break;
            case 0:
