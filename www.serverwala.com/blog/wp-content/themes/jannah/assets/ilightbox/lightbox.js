...
(function(g, p, Q) {
    ...
    function Z(a) {
        if (a.indexOf(".jpg") >= 0 && a.indexOf("?") >= 0 && a.indexOf("instagram.com") >= 0) {
            return 'jpg';
        } else if (/\.(jpg|jpeg|png|gif|webp)$/.test(a.replace('?ssl=1', ''))) {
            return 'jpg';
        }
    ...
    function da(a, b, c) {
        var d = r[a + b];
        null == d && (d = r[b]);
        return null != d ? (0 == b.indexOf(a) && null == c && (c =
    ...
    function ma() {
        ...
        if (4 > b.length || 0 != b.length % 2) b = na, b = b.replace("%%", a), alert(b), a = "";
            ...
            la("src", "width", "height", "pluginspage", "classid", "codebase", "name", "tabindex", "hspace", "vspace",
                "border", "align", "noexternaldata", "class", "title", "accesskey");
    ...
    var T = {
            flash: ["swf"],
            image: "bmp gif jpeg jpg png tiff tif jfif jpe webp".split(" "),
    ...
    fa.prototype = {
        ...
        hideLoader: function() {
            ...
            "horizontal" == this.options.path.toLowerCase() ?
                0 >= this.vars.loadRequests && this.vars.loader.removeClass("ilightbox-show").stop().animate({
                    top: "-192px"
        ...
        normalizeItems: function() {
            ...
            g.each(a.items, function(c, d) {
                ...
                f.social = "undefined" != typeof f.social ?
                    f.social : a.options.social.buttons && g.extend({}, {}, a.options.social.buttons);
                "video" == k && (f.html5video = "undefined" != typeof f.html5video ? f.html5video : {}, f.html5video.webm = f.html5video.webm || f.html5video.WEBM || null, f.html5video.controls = "undefined" != typeof f.html5video.controls ? f.html5video.controls : "controls", f.html5video.preload = f.html5video.preload || "metadata", f.html5video.autoplay = "undefined" != typeof f.html5video.autoplay ? f.html5video.autoplay : !1);
                f.width && f.height || ("video" == k ? (f.width = 1280, f.height =
                    720) : "iframe" == k ? (f.width = "100%", f.height = "90%") : "flash" == k && (f.width = 1280, f.height = 720));
                delete d.url;
                d.index = c;
                d.URL = e;
                d.caption = h;
        ...
        addContents: function() {
            var a = this,
                ...
                f = 0 < b.total && a.items.filter(function(a,
                    b, d) {
            ...
            c.controls.toolbar && (b.toolbar.addClass(c.skin).append(b.closeButton), c.controls.fullscreen && b.toolbar.append(b.fullScreenButton), c.controls.slideshow &&
                b.toolbar.append(b.innerPlayButton), 1 < b.total && b.toolbar.append(b.innerPrevButton).append(b.innerNextButton));
            ...
            c.controls.thumbnail && 1 < b.total && (b.BODY.append(b.thumbnails), b.thumbnails.addClass(c.skin).addClass("ilightbox-" + e), g("div.ilightbox-thumbnails-grid", b.thumbnails).empty(),
                b.thumbs = !0);
            ...
            c.infinite || (b.prevButton.add(b.prevButton).add(b.innerPrevButton).add(b.innerNextButton).removeClass("disabled"), 0 == b.current &&
                b.prevButton.add(b.innerPrevButton).addClass("disabled"), b.current >= b.total - 1 && b.nextButton.add(b.innerNextButton).addClass("disabled"));
            ...
            switch (a.type) {
                case "image":
                    ...
                    e.loadImage(a.URL, function(k) {
                        ...
                        g("div.ilightbox-container", b).empty().append(k ?
                            '<img src="' + a.URL + '" class="ilightbox-image" />' : '<span class="ilightbox-alert">' + f.errors.loadImage + "</span>");
                ...
                case "video":
                    ...
                    "current" === d ? (e.addContent(b, a), "function" == typeof f.callback.onRender && f.callback.onRender.call(e, e.ui, c), "function" == typeof a.options.onRender &&
                        a.options.onRender.call(e, h)) : g("div.ilightbox-container", b).empty();
                    e.configureHolder(a, d, b);
                    break;
                case "iframe":
                    b.data({
        ...
        configureHolder: function(a, b, c) {
            ...
            d.items[h].options.height = d.items[h].options.height ||
                0;
            "current" == b ? f.show.effect ? c.css(B, H).fadeIn(a.speed, function() {
                ...
                "function" == typeof a.options.onShow && a.options.onShow.call(d,
                    k)
                ...
                "function" == typeof a.options.onShow && a.options.onShow.call(d, k)
                    ...
                    opacity: l
                }).show(), "next" == b ? e.nextLock = !1 : e.prevLock = !1, d.generateThumbnails(),
                "function" == typeof f.callback.onShow && f.callback.onShow.call(d, d.ui, h), "function" == typeof a.options.onShow && a.options.onShow.call(d, k));
            setTimeout(function() {
                d.repositionPhoto()
            }, 0)
        },
        ...
        positionThumbnails: function(a, b, c) {
            ...
            3 > arguments.length ? c.stop().animate(y,
                f.effects.repositionSpeed, "easeOutCirc") : c.css(y)
        },
        ...
        dispatchItemsEvents: function() {
            this.context && this.selector ? g(this.context).off(".iL", this.selector) : g.each(this.itemsObject, function(a,
                b) {
                b.off(".iL")
            })
        },
        ...
        patchEvents: function() {
            ...
            O.bind("resize.iLightBox", function() {
                ...
                if (d.controls.keyboard) switch (a.keyCode) {
                    case 13:
                        a.shiftKey &&
                            d.keyboard.shift_enter && b.fullScreenAction();
                        break;
                    case 27:
            ...
            h = [d.caption.show + ".iLightBox", d.caption.hide + ".iLightBox", d.social.show + ".iLightBox", d.social.hide + ".iLightBox"].filter(function(a,
                b, c) {
            ...
            E.on(K, ".ilightbox-overlay", function() {
            ...
            }).on(n, ".ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)",
                function(a) {
                    ...
                    c.nextLock || c.prevLock ? (a.type != d.caption.show || b.is(":visible") ? a.type == d.caption.hide && b.is(":visible") && b.fadeOut(f) : b.fadeIn(f), a.type != d.social.show || e.is(":visible") ? a.type == d.social.hide && e.is(":visible") && e.fadeOut(f) : e.fadeIn(f)) : (a.type != d.caption.show || b.is(":visible") ? a.type == d.caption.hide && b.is(":visible") && b.stop().fadeOut(f) : b.stop().fadeIn(f), a.type != d.social.show || e.is(":visible") ?
                        a.type == d.social.hide && e.is(":visible") && e.stop().fadeOut(f) : e.stop().fadeIn(f))
                ...
                var a = g(this);
                a.hasClass("ilightbox-fullscreen") ? b.fullScreenAction() : a.hasClass("ilightbox-play") ? (b.resume(), a.addClass("ilightbox-pause").removeClass("ilightbox-play")) :
                    a.hasClass("ilightbox-pause") ? (b.pause(), a.addClass("ilightbox-play").removeClass("ilightbox-pause")) : b.closeAction()
            ...
            if (d.controls.slideshow && d.slideshow.pauseOnHover) E.on("mouseenter.iLightBox mouseleave.iLightBox", ".ilightbox-holder:not(.ilightbox-next, .ilightbox-prev)", function(a) {
                "mouseenter" == a.type && c.cycleID ? b.pause() : "mouseleave" == a.type && c.isPaused &&
                    b.resume()
            });
            ...
            if (d.controls.swipe) f.on(pa, function(a) {
                ...
                function k(a) {
                    if (w) {
                        var b = a.originalEvent.touches ? a.originalEvent.touches[0] :
                            a;
                        x = {
                ...
                if (!(c.nextLock || c.prevLock || 1 == c.total || c.lockSwipe)) {
                    ...
                    E.one(qa, function(a) {
                        ...
                        w && x && ("horizontal" == e && 1E3 > x.time - w.time && I(w.coords[0] - x.coords[0]) > l && I(w.coords[1] - x.coords[1]) < verticalDistanceThreshold ? w.coords[0] > x.coords[0] ? c.current != c.total - 1 || d.infinite ? (c.isSwipe = !0, b.moveTo("next")) :
                            q() : 0 != c.current || d.infinite ? (c.isSwipe = !0, b.moveTo("prev")) : q() : "vertical" == e && 1E3 > x.time - w.time && I(w.coords[1] - x.coords[1]) > l && I(w.coords[0] - x.coords[0]) < verticalDistanceThreshold ? w.coords[1] > x.coords[1] ? c.current != c.total - 1 || d.infinite ? (c.isSwipe = !0, b.moveTo("next")) : q() : 0 != c.current || d.infinite ? (c.isSwipe = !0, b.moveTo("prev")) : q() : q());
                        w = x = Q
                    })
                }
            })
        ...
        moveTo: function(a) {
            ...
            b.items[l].caption && (b.setCaption(b.items[l], k), q = g("div.ilightbox-caption", k), u = parseInt(q.outerHeight() / k.outerHeight() * 100), d.caption.start &&
                50 >= u && q.fadeIn(h));
            ...
            "prev" == a ? v = "horizontal" == e ? parseInt(q - x.offsetX - v.W - t.W / 2) : parseInt(q /
                2 - u / 2 - v.W - x.offsetY - t.W / 2) : (w = "horizontal" == e ? w : parseInt(x.offsetX - v.H - r - t.H / 2), v = "horizontal" == e ? parseInt(x.offsetX - v.W - u - t.W / 2) : parseInt(q / 2 - x.offsetY - u / 2 - v.W - t.W / 2));
            ...
            n.addClass(C).css(B, H).animate({
                ...
                "next" == a ? (c.nextPhoto = m, c.prevPhoto = n, c.holder = k, c.nextPhoto.hide(), c.next += 1, c.prev = c.current, c.current += 1, d.infinite && (c.current > c.total - 1 && (c.current = 0), c.current == c.total - 1 && (c.next = 0), 0 == c.current && (c.prev = c.total - 1)), b.createUI(), b.items[c.next] ? b.loadContent(b.items[c.next],
                    "next") : c.nextLock = !1) : (c.prevPhoto = m, c.nextPhoto = n, c.holder = k, c.prevPhoto.hide(), c.next = c.current, c.current = c.prev, c.prev = c.current - 1, d.infinite && (c.current == c.total - 1 && (c.next = 0), 0 == c.current && (c.prev = c.total - 1)), b.createUI(), b.items[c.prev] ? b.loadContent(b.items[c.prev], "prev") : c.prevLock = !1); - 1 !== ["iframe", "video"].indexOf(b.items[c.current].type) && b.loadContent(b.items[c.current], "current");
                d.linkId && setTimeout(function() {
                    c.hashLock = !1
                }, 55);
                d.infinite || (c.nextButton.add(c.prevButton).add(c.innerPrevButton).add(c.innerNextButton).removeClass("disabled"),
                    0 == c.current && c.prevButton.add(c.innerPrevButton).addClass("disabled"), c.current >= c.total - 1 && c.nextButton.add(c.innerNextButton).addClass("disabled"));
                b.repositionPhoto();
                b.resetCycle();
                "function" == typeof d.callback.onAfterChange && d.callback.onAfterChange.call(b, b.ui)
            });
        ...
        closeAction: function() {
            ...
            "function" ==
            typeof b.callback.onHide && b.callback.onHide.call(this, this.ui)
        },
        repositionPhoto: function() {
            ...
            var l = "horizontal" ==
                c ? parseInt(this.items[a.next] || this.items[a.prev] ? 2 * (b.styles.nextOffsetX + b.styles.prevOffsetX) : 30 >= e / 10 ? 30 : e / 10) : parseInt(30 >= e / 10 ? 30 : e / 10) + d,
        ...
        repositionEl: function(a) {
            ...
            "current" == a.type ? ("number" == typeof l.width && l.width && (e = b.isInFullScreen && c.fullAlone && (-1 != c.fullStretchTypes.indexOf(h.type) || l.fullViewPort || c.fullViewPort) ? e : l.width > e ? e : l.width),
                "number" == typeof l.height && l.height && (f = b.isInFullScreen && c.fullAlone && (-1 != c.fullStretchTypes.indexOf(h.type) || l.fullViewPort || c.fullViewPort) ? f : l.height > f ? f : l.height)) : ("number" == typeof l.width && l.width && (e = l.width > e ? e : l.width), "number" == typeof l.height && l.height && (f = l.height > f ? f : l.height));
            ...
            h = "string" ==
                typeof l.height && -1 != l.height.indexOf("%") ? ba(parseInt(l.height.replace("%", "")), a.height) : k.data("naturalHeight");
            ...
            f =
                parseInt((F(k, "padding-left") + F(k, "padding-right") + F(k, "border-left-width") + F(k, "border-right-width")) / 2);
            ...
            switch (a.type) {
                ...
                case "next":
                    ...
                    u = "horizontal" == d ? parseInt(a.width - n - f - p /
                        2) : parseInt(a.width / 2 - b / 2 - f - m - p / 2);
                    break;
                case "prev":
            ...
            0 < a.animate && c.effects.reposition ? (k.css(B, H).stop().animate({
                ...
                "easeOutCirc"), g("div.ilightbox-inner-toolbar", k).stop().animate({
                width: b
            }, c.effects.repositionSpeed, "easeOutCirc", function() {
        ...
        getNewDimenstions: function(a, b, c, d, e) {
            ...
            a = this.options.keepAspectRatio ?
                X(c * factor) : a;
        ...
        availPlugins: function() {
            ...
            this.plugins = {
                ...
                html5Vorbis: !(!a.canPlayType ||
                    !a.canPlayType("video/ogg").replace(/no/, "")),
        ...
        addContent: function(a, b) {
            switch (b.type) {
                case "video":
                    ...
                    !this.plugins.html5H264 || "video/mp4" !=
                        d && "mp4" != b.ext && "m4v" != b.ext ? !this.plugins.html5WebM || "video/webm" != d && "webm" != b.ext ? !this.plugins.html5Vorbis || "video/ogg" != d && "ogv" != b.ext ? !this.plugins.html5QuickTime || "video/quicktime" != d && "mov" != b.ext && "qt" != b.ext || (c = !0, d = "video/quicktime") : (c = !0, d = "video/ogg") : (c = !0, d = "video/webm") : (c = !0, d = "video/mp4");
                    if (c) var f = g("<video />", {
                        width: "100%",
                        height: "100%",
                        preload: e.preload,
                        ...
                        (f = g("<object />", {
                            ...
                            html: this.options.errors.missingPlugin.replace("{pluginspage}",
                                "http://www.apple.com/quicktime/download").replace("{type}", "QuickTime")
                        });
                    break;
                case "flash":
                    if (this.plugins.flash) {
                        ...
                        f = g("<embed />").attr({
                            ...
                            height: "number" == typeof b.options.height && b.options.height &&
                                "1" == this.options.minScale && "1" == this.options.maxScale ? b.options.height : "100%",
                            quality: "high",
                            bgcolor: "#000000",
                            play: "true",
                            loop: "true",
                ...
                case "iframe":
                    f = g("<iframe />").attr({
                        width: "number" ==
                            typeof b.options.width && b.options.width && "1" == this.options.minScale && "1" == this.options.maxScale ? b.options.width : "100%",
                ...
                case "html":
                    c =
                        b.URL, c[0].nodeName || (c = g(b.URL), c = c.selector ? g("<div>" + c + "</div>") : c), f = g('<div class="ilightbox-wrapper"></div>').html(c)
            }
    ...
    g.fn.iLightBox = function() {
        var a = arguments,
            ...
            c = g.isArray(a[0]) || "string" == typeof a[0] ?
            a[0] : a[1];
        b || (b = {});
        b = g.extend(!0, {
            attr: "href",
    ...
    (function() {
        ...
        if ("undefined" != typeof document.cancelFullScreen) t.supportsFullScreen = !0;
            ...
            for (var a = 0, b = browserPrefixes.length; a < b; a++)
                if (t.prefix =
                    browserPrefixes[a], "undefined" != typeof document[t.prefix + "CancelFullScreen"]) {
    ...
    var ha = {
        ...
        initScript: function() {
            ...
            this.OS = 100;
            if (f) {
                var h = ["Win", 1, "Mac", 2, "Linux", 3, "FreeBSD", 4, "iPhone", 21.1, "iPod", 21.2, "iPad", 21.3, "Win.*CE", 22.1, "Win.*Mobile", 22.2,
            ...
            if (this.isIE) {
                ...
                try {
                    b.style.behavior = "url(#default#clientcaps)", this.verIEfull = b.getComponentVersion("{89820200-ECBD-11CF-8B85-00AA005B4383}",
            ...
            this.verGecko = (this.isGecko = /Gecko/i.test(a) &&
                /Gecko\s*\/\s*\d/i.test(d)) ? this.formatNum(/rv\s*\:\s*([\.\,\d]+)/i.test(d) ? RegExp.$1 : "0.9") : null;
            ...
            this.verOpera = (this.isOpera = /Opera\s*[\/]?\s*(\d+\.?\d*)/i.test(d)) && (/Version\s*\/\s*(\d+\.?\d*)/i.test(d), 1) ? parseFloat(RegExp.$1,
                10) : null;
        ...
        isActiveXObject: function(a, b) {
            ...
            this.head.insertBefore(document.createElement("object"),
        ...
        addWinEvent: function(a, b) {
            if (this.isFunc(b))
                if (p.addEventListener) p.addEventListener(a,
                    b, !1);
        ...
        onDoneEmptyDiv: function() {
            var a, b;
            if (this.winLoaded && (!this.WLfuncs ||
                    !this.WLfuncs.length || null === this.WLfuncs[this.WLfuncs.length - 1])) {
                for (a in this)
        ...
        insertHTML: function(a, b, c, d, e) {
            ...
            if (this.div && this.div.parentNode) {
                this.setStyle(f, l.concat(["fontSize",
                    this.pluginSize + 3 + "px", "lineHeight", this.pluginSize + 3 + "px", "verticalAlign", "baseline", "display", "inline"
                ]));
                try {
                    f.innerHTML = k
                } catch (n) {}
            ...
            flash: {
                ...
                getVersion: function() {
                    ...
                    if (b.isIE) {
                        ...
                        d || ((c = e ? e.enabledPlugin : null) && c.description && (d = a(c.description)), d && (d = b.getPluginFileVersion(c,
                            d)))
                    }
    ...
    (function() {
        ...
        var b = document,
            c = g.event.special,
            d = b.documentMode,
            e = "oniLightBoxHashChange" in p && (void 0 ===
                d || 7 < d);
    ...
    Array.prototype.lastIndexOf || (Array.prototype.lastIndexOf = function(a) {
        ...
        if (0 === c) return -1;
        var d = c;
        1 < arguments.length && (d = Number(arguments[1]), d != d ? d = 0 : 0 != d && d != 1 / 0 && d != -(1 / 0) &&
            (d = (0 < d || -1) * M(I(d))));
