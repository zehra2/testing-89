...
function(t) {
    ...
    e.VERSION = "3.4.0", e.TRANSITION_DURATION = 150, e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            p && (l = l.replace(a, "") || "top"), s.detach().css({
                ...
                left: 0,
                display: "block"
            }).addClass(l).data("bs." + this.type, this), this.options.container ? s.appendTo(t(document).find(this.options.container)) : s.insertAfter(this.$element), this.$element.trigger("inserted.bs." + this.type);
    ...
    var i = t.fn.tietooltip;
    t.fn.tietooltip = function(i) {
    ...
    }, t.fn.tietooltip.Constructor = e, t.fn.tietooltip.noConflict = function() {
