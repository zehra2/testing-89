! function(e) {
    ...
    t = function() {
        function t(t, o) {
            ...
            n.defaults = {
                ...
                customPaging: function(t, i) {
                    return e('<button type="button" data-role="none" tabindex="0" />').text(i + 1)
                },
                dots: !1,
        ...
        if ("window" === a.respondTo ? n = l : "slider" === a.respondTo ? n = d : "min" === a.respondTo && (n = Math.min(l, d)), a.options.responsive && a.options.responsive.length && null !== a.options.responsive) {
            s = null;
        ...
        switch (r.is("a") && t.preventDefault(), r.is("li") || (r = r.closest("li")), n = a.slideCount % a.options.slidesToScroll !== 0, o = n ? 0 : (a.slideCount - a.currentSlide) % a.options.slidesToScroll, t.data.message) {
            ...
            case "next":
                ...
                break;
            case "index":
                var d = 0 === t.data.index ? 0 : t.data.index || r.index() * a.options.slidesToScroll;
                a.slideHandler(a.checkNavigable(d), !1, i), r.children().trigger("focus");
                break;
            default:
                return
        }
        ...
        t.$slides.add(t.$slideTrack.find(".slick-cloned")).attr({
            ...
            e(this).attr({
                role: "option",
                "data-aria-describedby": "slick-slide" + t.instanceUid + i
            })
        }), null !== t.$dots && t.$dots.find("li").each(function(i) {
            e(this).attr({
                "aria-selected": "false",
        ...
        return t = t || !1, l.animating === !0 && l.options.waitForAnimate === !0 || l.options.fade === !0 && l.currentSlide === e || l.slideCount <= l.options.slidesToShow ? void 0 : (t === !1 && l.asNavFor(e), o = e, d = l.getLeft(o), a = l.getLeft(l.currentSlide), l.currentLeft = null === l.swipeLeft ? a : l.swipeLeft, l.options.infinite === !1 && l.options.centerMode === !1 && (0 > e || e > l.getDotCount() * l.options.slidesToScroll) ? void(l.options.fade === !1 && (o = l.currentSlide, i !== !0 ? l.animateSlide(a, function() {
            ...
            l.postSlide(o)
        }) : l.postSlide(o))) : (l.options.autoplay && clearInterval(l.autoPlayTimer), s = 0 > o ? l.slideCount % l.options.slidesToScroll !== 0 ? l.slideCount - l.slideCount % l.options.slidesToScroll : l.slideCount + o : o >= l.slideCount ? l.slideCount % l.options.slidesToScroll !== 0 ? 0 : o - l.slideCount : o, l.animating = !0, l.$slider.trigger("beforeChange", [l, l.currentSlide, s]), n = l.currentSlide, l.currentSlide = s, l.setSlideClasses(l.currentSlide), l.options.asNavFor && (r = l.getNavTarget(), r = r.slick("getSlick"), r.slideCount <= r.options.slidesToShow && r.setSlideClasses(l.currentSlide)), l.updateDots(), l.updateArrows(), l.options.fade === !0 ? (i !== !0 ? (l.fadeSlideOut(n), l.fadeSlide(s, function() {
            l.postSlide(s)
        })) : l.postSlide(s), void l.animateHeight()) : void(i !== !0 ? l.animateSlide(d, function() {
            l.postSlide(s)
        }) : l.postSlide(s))))
        ...
        var t, i, o, s, n, a = this;
        return n = void 0 !== e.originalEvent ? e.originalEvent.touches : null, !a.dragging || n && 1 !== n.length ? !1 : (t = a.getLeft(a.currentSlide), a.touchObject.curX = void 0 !== n ? n[0].pageX : e.clientX, a.touchObject.curY = void 0 !== n ? n[0].pageY : e.clientY, a.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(a.touchObject.curX - a.touchObject.startX, 2))), a.options.verticalSwiping === !0 && (a.touchObject.swipeLength = Math.round(Math.sqrt(Math.pow(a.touchObject.curY - a.touchObject.startY, 2)))), i = a.swipeDirection(), "vertical" !== i ? (void 0 !== e.originalEvent && a.touchObject.swipeLength > 4 && e.preventDefault(), s = (a.options.rtl === !1 ? 1 : -1) * (a.touchObject.curX > a.touchObject.startX ? 1 : -1), a.options.verticalSwiping === !0 && (s = a.touchObject.curY > a.touchObject.startY ? 1 : -1), o = a.touchObject.swipeLength, a.touchObject.edgeHit = !1, a.options.infinite === !1 && (0 === a.currentSlide && "right" === i || a.currentSlide >= a.getDotCount() && "left" === i) && (o = a.touchObject.swipeLength * a.options.edgeFriction, a.touchObject.edgeHit = !0), a.options.vertical === !1 ? a.swipeLeft = t + o * s : a.swipeLeft = t + o * (a.$list.height() / a.listWidth) * s, a.options.verticalSwiping === !0 && (a.swipeLeft = t + o * s), a.options.fade === !0 || a.options.touchMove === !1 ? !1 : a.animating === !0 ? (a.swipeLeft = null, !1) : void a.setCSS(a.swipeLeft)) : void 0)
...
jQuery(document).ready(function() {
    "use strict";
    var e = jQuery(".scrolling-slider");
    e.length && (e.each(function(e) {
        var t = ".slide",
            i = jQuery(this),
            o = i.parents(".section-item").hasClass("full-width") ? !0 : !1,
            s = i.closest(".scrolling-box"),
            n = o ? 4 : 3,
            a = s.attr("id") ? s.attr("id") : "scrolling-slider" + e;
        1 == i.parents(".latest-poroducts-slider-box").length && (t = ".product"), s.attr("id", a), jQuery(i).on("init", function() {
            ...
            slidesToShow: n,
            slidesToScroll: n,
            appendArrows: "#" + a + " .slider-arrow-nav",
    ...
    }), tie.lazyload && e.find(".lazy-img").each(function() {
        jQuery(this).attr("src", jQuery(this).attr("data-src")).removeAttr("data-src")
    }));
    var t = jQuery(".latest-tweets-widget").find(".tie-slick-slider");
    t.length && t.each(function(e, t) {
        var i = "latest-tweets-slider-" + e,
            o = jQuery(this);
        jQuery(t).parents(".widget").attr("id", i), o.slick({
            dots: !1,
            vertical: !0,
            draggable: !1,
            slide: ".slide",
            ...
            slidesToShow: 1,
            slidesToScroll: 1
        }), o.fadeIn(500), o.slick("setPosition")
    });
    var i = jQuery(".slider-in-widget");
    i.length && i.each(function(e) {
        var t, i = "slider-in-widget-" + e,
            o = jQuery(this),
            s = o.find(".tie-slick-slider");
        if (o.closest(".main-slider").attr("id", i), 1 == o.parents(".fullwidth-area").length) var n = 5,
            t = [{
                breakpoint: 1024,
                settings: {
                    slidesToShow: 4,
        ...
        s.slick({
            ...
            responsive: t
        }), tie.lazyload && jQuery(s).on("lazyLoaded", function(e, t, i, o) {
            i.hide(), i.next(".slide-bg").css("background-image", 'url("' + o + '")')
        }), s.fadeIn(1e3, function() {
        ...
        if (2 == s) d.asNavFor = "", d.infinite = !0, d.slidesToShow = 3, d.slidesToScroll = 3, d.slidesOn1280 = 3, d.slidesOn1024 = 2, d.slidesOn992 = 2, d.slidesOn768 = 2, d.slidesOn670 = 2, a ? (d.slidesToShow = 2, d.slidesToScroll = 2, d.slidesOn1280 = 2, d.slidesOn1024 = 1) : r && (d.slidesToShow = is_boxed_layout ? 3 : 4, d.slidesToScroll = is_boxed_layout ? 3 : 4, d.slidesOn1280 = 3);
        else if (4 == s || 50 == s) {
            d.asNavFor = e.next(".wide-slider-nav-wrapper").find(".tie-slick-slider"), d.infinite = !0, d.showArrows = !1, d.showArrowsOn1280 = !1, d.showArrowsOn1024 = !1, d.showArrowsOn992 = !1;
            var l = e.next(".wide-slider-nav-wrapper"),
                c = l.find(".tie-slick-slider"),
                h = l.find(".tie-slider-nav");
            50 == s && (d.fade = !0), c.length && (c.slick({
                slidesToShow: a ? 3 : 4,
                vertical: 50 == s ? !0 : !1,
                centerMode: 50 == s ? !0 : !1,
                rtl: 50 == s ? !1 : is_RTL,
        ...
        3 == s && (d.centerMode = !0), jQuery(i).on("init", function() {
            ...
            i.hide(), i.next(".slide-bg").css("background-image", 'url("' + o + '")')
        }), (2 == s || 5 == s || 6 == s || 7 == s) && jQuery(i).fadeIn(1e3, function() {
