...
(function(d) {
    ...
    l.fontawesome.info_icon = "fa fa-info";
    ...
    var w = function() {
        n = d("body");
        d.pnotify.defaults.stack.context = n;
        k = d(window);
        k.bind("resize", function() {
            m && clearTimeout(m);
            m = setTimeout(function() {
                    d.pnotify_position_all(!0)
                },
                10)
        })
    };
    d.extend({
        pnotify_remove_all: function() {
            var g = k.data("pnotify");
            g && g.length && d.each(g, function() {
                this.pnotify_remove && this.pnotify_remove()
            })
        },
        pnotify_position_all: function(g) {
            m && clearTimeout(m);
            m = null;
            var e = k.data("pnotify");
            e && e.length && (d.each(e, function() {
                var a = this.opts.stack;
                a && (a.nextpos1 = a.firstpos1, a.nextpos2 = a.firstpos2, a.addpos2 = 0, a.animation = g)
            }), d.each(e, function() {
        ...
        pnotify: function(g) {
            var e, a;
            "object" !== typeof g ? (a = d.extend({}, d.pnotify.defaults), a.text =
                g) : a = d.extend({}, d.pnotify.defaults, g);
            for (var u in a) "string" === typeof u && u.match(/^pnotify_/) && (a[u.replace(/^pnotify_/, "")] = a[u]);
            if (a.before_init && !1 === a.before_init(a)) return null;
            var p, t = function(a, c) {
                    b.css("display", "none");
                    ...
                    p && p.get(0) == f || (p && (s.call(p.get(0), "mouseleave", a.originalEvent), s.call(p.get(0), "mouseout", a.originalEvent)), s.call(f, "mouseenter",
                        a.originalEvent), s.call(f, "mouseover", a.originalEvent));
                    s.call(f, c, a.originalEvent);
                    p = e
                },
                f;
            f = "object" === typeof a.styling ? a.styling : l[a.styling];
            var b = d("<div />", {
                ...
                mouseenter: function(q) {
                    a.nonblock && q.stopPropagation();
                    a.mouse_reset && "out" === e && (b.stop(!0), e = "in", b.css("height", "auto").animate({
                        width: a.width,
                        opacity: a.nonblock ? a.nonblock_opacity : a.opacity
                    }, "fast"));
                    a.nonblock && b.stop().animate({
                        opacity: a.nonblock_opacity
                    }, "fast");
                    a.hide && a.mouse_reset &&
                ...
                mouseleave: function(q) {
                    ...
                    p = null;
                    b.css("cursor", "auto");
                    a.nonblock && "out" !== e && b.stop().animate({
                        opacity: a.opacity
                    }, "fast");
                ...
                mousemove: function(b) {
                    a.nonblock && (b.stopPropagation(), t(b, "onmousemove"))
                },
                mousedown: function(b) {
                    a.nonblock && (b.stopPropagation(), b.preventDefault(), t(b, "onmousedown"))
                },
                mouseup: function(b) {
                    a.nonblock && (b.stopPropagation(), b.preventDefault(), t(b, "onmouseup"))
                },
                click: function(b) {
                    a.nonblock && (b.stopPropagation(), t(b, "onclick"))
                },
                dblclick: function(b) {
                    a.nonblock && (b.stopPropagation(), t(b, "ondblclick"))
                }
            });
            b.opts = a;
            b.container = d("<div />", {
            ...
            b.pnotify_version = "1.3.1";
            b.pnotify = function(q) {
                var c = a;
                "string" === typeof q ? a.text = q : a = d.extend({}, a, q);
                for (var e in a) "string" === typeof e && e.match(/^pnotify_/) && (a[e.replace(/^pnotify_/,
                    "")] = a[e]);
                b.opts = a;
                ...
                if (a.icon !== c.icon || !0 === a.icon && a.type !== c.type) b.container.find("div.ui-pnotify-icon").remove(), !1 !== a.icon && d("<div />", {
                ...
                !a.sticker ||
                    a.nonblock ? b.sticker.css("display", "none") : b.sticker.css("display", "block");
                ...
                b.pnotify_queue_position(!0);
                return b
            };
            b.pnotify_position = function(a) {
                var c = b.opts.stack;
                "undefined" === typeof c.context && (c.context =
                    n);
                if (c) {
                    "number" !== typeof c.nextpos1 && (c.nextpos1 = c.firstpos1);
                    "number" !== typeof c.nextpos2 && (c.nextpos2 = c.firstpos2);
                    "number" !== typeof c.addpos2 && (c.addpos2 = 0);
                    ...
                    if (!d || a) {
                        ...
                        a = parseInt(b.css(g).replace(/(?:\..*|[^0-9.])/g, ""));
                        isNaN(a) && (a = 0);
                        ...
                        f = parseInt(b.css(h).replace(/(?:\..*|[^0-9.])/g, ""));
                        isNaN(f) && (f = 0);
                        "undefined" !== typeof c.firstpos2 || d || (c.firstpos2 = f, c.nextpos2 = c.firstpos2);
                        if ("down" === c.dir1 && c.nextpos1 + b.height() > (c.context.is(n) ? k.height() : c.context.prop("scrollHeight")) || "up" === c.dir1 && c.nextpos1 + b.height() > (c.context.is(n) ? k.height() : c.context.prop("scrollHeight")) || "left" === c.dir1 && c.nextpos1 + b.width() > (c.context.is(n) ? k.width() : c.context.prop("scrollWidth")) ||
                            "right" === c.dir1 && c.nextpos1 + b.width() > (c.context.is(n) ? k.width() : c.context.prop("scrollWidth"))) c.nextpos1 = c.firstpos1, c.nextpos2 += c.addpos2 + ("undefined" === typeof c.spacing2 ? 25 : c.spacing2), c.addpos2 = 0;
                        ...
                        } else "number" === typeof c.nextpos2 && b.css(h, c.nextpos2 + "px");
                        switch (c.dir2) {
                            case "down":
                            case "up":
                                b.outerHeight(!0) >
                                    c.addpos2 && (c.addpos2 = b.height());
                                break;
                            case "left":
                            case "right":
                                b.outerWidth(!0) > c.addpos2 && (c.addpos2 = b.width())
                        }
                        if ("number" === typeof c.nextpos1)
            ...
            b.pnotify_queue_position = function(a, b) {
                m && clearTimeout(m);
                b || (b = 10);
                m = setTimeout(function() {
                    d.pnotify_position_all(a)
                }, b)
            };
            b.pnotify_display = function() {
                if ((h = k.data("pnotify")) && h.length > a.maxonscreen) {
                    var e;
                    e = "top" !== a.stack.push ? h.slice(0, h.length - a.maxonscreen) : h.slice(a.maxonscreen,
                        h.length);
                    d.each(e, function() {
                        this.pnotify_remove && this.pnotify_remove()
                    })
                }
                b.parent().length || b.appendTo(a.stack.context ? a.stack.context : n);
            ...
            b.pnotify_remove = function(e) {
                b.timer &&
                    (window.clearTimeout(b.timer), b.timer = null);
                a.before_close && !1 === a.before_close(b, e) || b.animate_out(function() {
                    if (!a.after_close || !1 !== a.after_close(b, e))
                        if (b.pnotify_queue_position(!0), a.remove && b.detach(), !a.history) {
                            var c = k.data("pnotify");
                            if (null !== c) {
                                var f = d.inArray(b, c); - 1 !== f && c.splice(f, 1)
                            }
                        }
                })
            };
            b.animate_in = function(d) {
                ...
                "none" === c ? (b.show(), d()) : "show" === c ? b.show(a.animate_speed, d) : "fade" === c ? b.show().fadeTo(a.animate_speed,
                    a.opacity, d) : "slide" === c ? b.slideDown(a.animate_speed, d) : "function" === typeof c ? c("in", d, b) : b.show(c, "object" === typeof a.animation.options_in ? a.animation.options_in : {}, a.animate_speed, d)
            };
            b.animate_out = function(d) {
                e = "out";
                var c;
                c = "undefined" !== typeof a.animation.effect_out ? a.animation.effect_out : a.animation;
                "none" === c ? (b.hide(), d()) : "show" === c ? b.hide(a.animate_speed, d) : "fade" === c ? b.fadeOut(a.animate_speed, d) : "slide" === c ? b.slideUp(a.animate_speed, d) : "function" === typeof c ? c("out", d, b) : b.hide(c, "object" ===
                    typeof a.animation.options_out ? a.animation.options_out : {}, a.animate_speed, d)
            };
            ...
            b.closer = d("<div />", {
                ...
                click: function() {
                    ...
                    b.closer.css("visibility",
                        "hidden")
                }
            }).append(d("<span />", {
                "class": f.closer,
                title: a.labels.close
            ...
            b.sticker = d("<div />", {
                ...
                d(this).children().removeClass(f.pin_up + " " + f.pin_down).addClass(a.hide ? f.pin_up :
                    f.pin_down)
            }).append(d("<span />", {
                "class": f.pin_up,
                title: a.labels.stick
            })).appendTo(b.container);
            ...
            !1 === a.title ? b.title_container.hide() :
                a.title_escape ? b.title_container.text(a.title) : b.title_container.html(a.title);
            ...
            k.data("pnotify", h);
            "top" === a.stack.push && b.pnotify_queue_position(!1, 1);
            a.after_init && a.after_init(b);
            if (a.history) {
                var r = k.data("pnotify_history");
                "undefined" === typeof r && (d("body").on("pnotify.history-all", function() {
                    d.each(h, function() {
                    ...
                    function() {
                        var a = "top" === d.pnotify.defaults.stack.push,
                            b = a ? 0 : -1,
                            e;
                        do {
                            e = -1 === b ? h.slice(b) : h.slice(b, b + 1);
                            if (!e[0]) return !1;
                            b = a ? b + 1 : b - 1
                        } while (!e[0].pnotify_history || e[0].is(":visible"));
                        e[0].pnotify_display && e[0].pnotify_display()
                    }), r = d("<div />", {
                    ...
                    click: function() {
                        d(this).trigger("pnotify.history-all");
                        return !1
                    }
                })).append(d("<button />", {
                    ...
                    click: function() {
                        d(this).trigger("pnotify.history-last");
                        return !1
                    }
                })).appendTo(n), v = d("<span />", {
                    "class": "ui-pnotify-history-pulldown " +
                        f.hi_hnd,
                    mouseenter: function() {
                        r.animate({
                            top: "0"
                ...
                }).appendTo(r).offset().top + 2, r.css({
                    top: "-" + v + "px"
                }), k.data("pnotify_history", r))
            }
            a.stack.animation = !1;
    ...
    var x = /^on/,
        ...
        s = function(g, e) {
            var a;
            g = g.toLowerCase();
            document.createEvent && this.dispatchEvent ? (g =
